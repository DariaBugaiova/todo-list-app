...
import { Roleaccess, Roles, UserCred, UserInfo, UserI } from "../../model/user"
...
export const beginRegister=createAction(BEGIN_REGISTER,props<{userdata:UserI}>())
...
export const getuserssuccess=createAction(GET_USER_SUCC,props<{userlist:UserI[]}>())
